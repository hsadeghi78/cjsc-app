...
import com.am.cjsc.service.ProductQueryService;
import com.am.cjsc.service.ProductService;
...
/**
 * REST controller for managing {@link com.am.cjsc.domain.Product}.
 */
@RestController
@RequestMapping("/api")
public class ProductResource {
    ...
    public ResponseEntity<List<ProductDTO>> searchProduct(String searchText, Pageable pageable) {
        log.debug("REST request to get DunningRules by searchText: {}", searchText);
